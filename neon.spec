...
Source0  : https://notroj.github.io/neon/neon-0.32.5.tar.gz
...
%prep
%setup -q -n neon-0.32.5
cd %{_builddir}/neon-0.32.5
pushd ..
cp -a neon-0.32.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707088182
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libneon.so.27.5.5
/usr/lib64/libneon.so.27
/usr/lib64/libneon.so.27.5.5
